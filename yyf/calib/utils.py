...
def visualize_stereo_pair(
    ...
    # 宽度对齐：RS 更宽（480 vs 320），TM resize 到 480 宽
    tm_vis = cv2.resize(tm_vis, (960, 480))
    vis = np.hstack([tm_vis, rs_vis])
    path = os.path.join(output_dir, f"corners_{frame_id:04d}.png")
